...
// Variante de animație pentru secțiuni
...
export default function AboutPage() {
  return (
    <div className="container mx-auto px-6 py-12 space-y-24">
      ...
      >
        <h1 className="text-5xl md:text-7xl font-bold mb-4 tracking-tight">Povestea Noastră</h1>
      ...
      >
        <div className="relative h-96 lg:h-[500px] rounded-2xl overflow-hidden shadow-2xl" style={{ boxShadow: `0 0 40px 10px rgba(74, 144, 226, 0.2)` }}>
          <Image 
            src="/images/ethiopia-yirgacheffe.jpg" // O altă imagine pentru diversitate
